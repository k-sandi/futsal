...
<form action="hasil_input_data_jadwal.php" method="post">
	Tipe Jadwal:<br><input type="text" name="type" class="ed"><br>
	Harga:<br><input type="text" name="price" class="ed"><br>
	Nomor Jam Booking:<br><input type="text" name="seat" class="ed"><br>
	Waktu:<br><input type="text" name="time" class="ed" placeholder="10:30am"><br>
